...
namespace WTS_CodingTest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<WTSContext>(options => options.UseSqlServer(Configuration.GetConnectionString("WTSContextConnection")));
            services.AddDbContext<WTSContext>();
